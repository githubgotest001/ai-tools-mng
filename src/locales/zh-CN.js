export default {
  ...
  platform: {
    ...
    cursor: {
      ...
      grokBotShort: 'Bot',
      planShort: '套餐',
      planAvailableHint: '本账期套餐额度剩余比例，按官方账单金额（剩余/额度）计算，与仪表盘“已用 X% 套餐额度”口径一致',
      autoAvailableHint: 'Cursor 自有模型本账期剩余额度，来自官方缓存的聚合百分比，活跃账号可能滞后',
      apiAvailableHint: '第三方模型本账期剩余额度，来自官方缓存的聚合百分比，活跃账号可能滞后',
