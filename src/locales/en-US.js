export default {
  ...
  platform: {
    ...
    cursor: {
      ...
      grokBotShort: 'Bot',
      planShort: 'Plan',
      planAvailableHint: 'Remaining included usage this billing cycle, computed from the billed amount (remaining / limit). Same basis as the dashboard\u2019s "You\u2019ve used X% of your included usage".',
      autoAvailableHint: 'Remaining Cursor-model allowance this billing cycle. Comes from Cursor\u2019s cached aggregate and can lag on active accounts.',
      apiAvailableHint: 'Remaining third-party model allowance this billing cycle. Comes from Cursor\u2019s cached aggregate and can lag on active accounts.',
